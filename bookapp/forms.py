...
class BookForm(forms.ModelForm):
    class Meta:
        ...
        widgets= {
            ...
            'author': forms.Select(attrs={'class': 'form-control', 'placeholder': 'enter the bookauthor'}),
            'price': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'enter the book price'}),
            'quantity': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'enter the book price'})
